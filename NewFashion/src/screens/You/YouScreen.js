...
const menuItems = [
  { id: "1", image: require('../../assets/icons/ic_message.png'), text: "Messages" },
  { id: "2", image: require('../../assets/icons/ic_yourOrder.png'), text: "Your orders" },
  { id: "3", image: require('../../assets/icons/ic_couponPercent.png'), text: "Coupons & offers" },
  { id: "4", image: require('../../assets/icons/ic_Adress.png'), text: "Addresses" },
  { id: "5", image: require('../../assets/icons/ic_support.png'), text: "Customer support" },
  { id: "6", image: require('../../assets/icons/ic_settings.png'), text: "Settings" },
];
const userData = {
  name: "Minhyu Do",
  avatar: 'https://s3-alpha-sig.figma.com/img/c375/02e3/5d906d3d9698632a4b0f88206e88c6d5?Expires=1741564800&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=Vt1tkOomEuFPYabzA6hndU2ZQpzrK13gmW9hM9ipxVCzmmxh48FDgtZnd1Ry18GC-czFt-q0VPNTCcmN4R3o9vjiGTxnIJoWoYJFXnCWthe7mLgdxBbvPjg5o3pAaS3J-BU19OB4iKe2PW5er~Q8afqiRkLqBtpUhGuFylN615DvL8tcIIWZCcxXTR813AJR-10ZK2nXsASy4tQq9Cmpvew3~KJ-iDsZVOHLQqKu86Jgc8aTApJRRAKXhCJ1ak~bWels~hwDxuXa0pOdSl10Qua0s5qx4JGQG-uWNOr6qamXQp9v6IETZnWiwlMk9SlvCfFID5P-cqNgROCRfI~0tg__',
};
const bottomMenuItems = [
  { id: "1", title: "Addresses", icon: require('../../assets/icons/ic_Adress.png') },
  { id: "2", title: "Notification", icon: require('../../assets/icons/ic_notification.png') },
  { id: "3", title: "Coupons & offers", icon: require('../../assets/icons/ic_couponPercent.png') },
];
              ...
              <>
                <View>
                  <View style={st.header}>
                    <Text style={st.title}>Sign in for the best experience</Text>
                    ...
                    <FilledButton title="Sign in / Register" customStyle={{ backgroundColor: 'black', width: '100%', marginTop: 20 }} onPress={() => navigation.navigate('Login')} />
                  </View>
                  {/* menu item */}
                  ...
                  <View style={st.historyItem}>
                    ...
                    <View style={{ flexDirection: 'row' }}>
                      <Text style={{ fontSize: 13, color: '#737373', fontWeight: '700', flex: 1 }}>Sign in to view recently viewed items</Text>
                      <Image source={require('../../assets/icons/ic_next.png')} style={{ height: 15, width: 15 }} resizeMode="contain" />
                    </View>
                  </View>
                </View>
              </>
                ...
                <View>
                  <View style={st.userInfo}>
                    ...
                    <View style={st.headerIcons}>
                      <Image source={require('../../assets/icons/ic_support.png')} style={st.icon} />
                      <Image source={require('../../assets/icons/ic_settings.png')} style={st.icon} />
                    </View>
                  </View>
                  ...
                  <Text style={[st.sectionTitle, { marginLeft: 15, marginTop: 5 }]}>Browsing history</Text>
                </View>
              </>
            )}
          </View>
