...
import {
  ...
  updateInformation,
} from '../actions/infomationActions';
  ...
  extraReducers: builder => {
    builder
      ...
      .addCase(updateInformation.fulfilled, (state, action) => {
        const index = state.personalInfo.information.findIndex(
      ...
      .addCase(deleteInformation.fulfilled, (state, action) => {
        state.personalInfo.information = state.personalInfo.information.filter(
